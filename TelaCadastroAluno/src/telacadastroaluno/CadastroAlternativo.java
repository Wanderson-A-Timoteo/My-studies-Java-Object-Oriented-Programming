 ...
 * @author Jivago
 */
public class CadastroAlternativo extends javax.swing.JFrame {

    /**
     * Creates new form CadastroAlternativo
     */
    public CadastroAlternativo() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroAlternativo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroAlternativo().setVisible(true);
            }
        });
    }
