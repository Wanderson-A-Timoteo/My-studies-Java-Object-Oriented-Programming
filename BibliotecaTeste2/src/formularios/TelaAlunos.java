...
public class TelaAlunos extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        lbAlunosCadastrados.getAccessibleContext().setAccessibleName("LISTA DE ALUNOS");
        lbAlunosCadastrados.getAccessibleContext().setAccessibleDescription("");
