...
{
    //usado para insert
    public  String SQL_tabela;
    public  String SQL_colunas;
    public  String SQL_valores;
    ...
    public void inserir() 
    {
            ...
            {
                SQL_tabela="cliente";
                SQL_colunas="(nome,cpf,idade,endereco)";
                SQL_valores="("+"'"+this.getNome()+"'"+","+"'"+this.getCpf()+"'"+","
                              +"'"+this.getIdade()+"'"+","+"'"+this.getEndereco()+"'"+")";
